    ...
    <div class="grid grid-cols-3 divide-x divide-gray-200">
        ...
        <div class="col-span-2">
            ...
            <div class="bg-gray-100 h-16 flex items-center px-3">
                ...
                <figure>
                    <img class="w-10 h-10 rounded-full object-cover object-center" src="{{$contactChat->user->profile_photo_url}}" alt=" ">
                </figure>
                <div class="ml-4">
                    <p class="text-gray-800">
                        {{$contactChat->name}}
            ...
            <form action="" class="bg-gray-100 h-16 flex items-center px-4 " wire:submit.prevent="sendMessage()">
