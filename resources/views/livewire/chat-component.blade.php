    ...
    <div class="grid grid-cols-3 divide-x divide-gray-200">
                    ...
                    <div class="px-4 py-3">
                        ...
                        <ul class="space-y-4">
                            @forelse ($this->contacts as $contact)
                                <li class="curso-pointer" wire:click="open_chat_contact({{ $contact }})">
                                    <div class="flex">
                                        <figure class="flex-shrink-0">
                                            <img class="h-12 w-12 rounded-full"
                                                src="{{ $contact->user->profile_photo_url }}" alt="">
                                        </figure>
                                        <div class="flex-1 ml-5 border-b border-gray-300">
                ...
                @else
                    @foreach ($this->chats as $chatItem)
                        <div wire:key="chats-{{ $chatItem->id }}" wire:click="open_chat({{ $chatItem }})"
                            class="px-3 flex items-center justify-between {{ $chat && $chat->id == $chatItem->id ? 'bg-gray-100' : 'bg-white' }}  hover:bg-gray-100 cursor-pointer">

                            <figure>
                                <img src="{{ $chatItem->image }}"
                                    class="h-12 w-12  object-cover object-center rounded-full" alt="">
        ...
        <div class="col-span-2">
            ...
            @if ($contactChat || $chat)
                    ...
                    <figure>
                        ...
                        @else
                            <img class="w-10 h-10 rounded-full object-cover object-center"
                                src="{{ $contactChat->user->profile_photo_url }}" alt=" ">
                        @endif
                ...
                <form action="" class="bg-gray-100 h-16 flex items-center px-4 "
            ...
            @else
                <div class="w-full h-full flex justify-center items-center">
                    ...
                    <div>
                        <div class="_3SOOk" style="opacity: 1;"><span data-testid="intro-md-beta-logo-dark"
                                data-icon="intro-md-beta-logo-dark" class="_3PwsU"><svg viewBox="0 0 303 172"
                                    width="360" preserveAspectRatio="xMidYMid meet" class="" fill="none">
                                    ...
                                    <rect x="0.445307" y="0.549558" width="50.4027" height="99.7216" rx="7.5"
                                        ...
                                        fill="#EEFAF6" stroke="#316474"></rect>
                                    <path
                        ...
                        <h1 class=" text-center text-gray-500 text-2xl mt-4"> Bienvenido Joan</h1>
                    </div>
